...
/* harmony import */ var _vendor_smooth_scroll__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/smooth-scroll */ "./js/vendor/smooth-scroll.js");
...
var smoothScroll = function smoothScroll() {
  ...
  (function (global, factory) {
    (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && __webpack_require__(/*! !webpack amd options */ "../node_modules/webpack/buildin/amd-options.js") ? define(factory) : (global = global || self, global.SmoothScroll = factory());
  })(_this, function () {
    'use strict'; //
    // Default settings
    //
    ...
    var SmoothScroll = function SmoothScroll(selector, options) {
      ...
      var popstateHandler = function popstateHandler() {
        ...
        if (!history.state.smoothScroll || history.state.smoothScroll !== JSON.stringify(settings)) return; // Get the anchor
